...
<html>
    ...
    <body>
        ...
        <div id="show-usertable" class="content scaffold-show" role="main">
            ...
            <f:display bean="usertable" />
            <g:form resource="${this.usertable}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.usertable}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
